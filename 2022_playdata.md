...
- 분야 : 객체 지향 프로그래밍 활용
- 주요 내용 :  회원 정보, 상품 정보, 품목 추가 및 제거 기능, 판매 및 구매 기능 등이 구현된 패키지 설계
...
<details><summary><h3>🎁 hotelDalgona 패키지 설계하기</h3></summary>

- 분야 : 객체 지향 프로그래밍 활용
- 주요 내용 :  
- 주요 언어 : <img alt="Java" src="https://img.shields.io/badge/Java%20-%2314354C.svg?style=flat-square&logo=java&logoColor=white"/>
- 주요 라이브러리 : 
- 주요 개발 환경 : <img src="https://img.shields.io/badge/Google%20Colab-F9AB00?style=flat-square&logo=Google Colab&logoColor=white"/>
- [**바로 가기**](https://github.com/jayarnim/PROJECT_MARKETKURLY)
</details>
